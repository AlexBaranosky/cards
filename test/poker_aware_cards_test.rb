...
class PokerAwareCardsTest < Test::Unit::TestCase
  ...
  def test_should_error_when_given_too_many_cards
    assert_raise Game::NotFiveCards do
      poker_aware_cards_for("3 Spades", "2 Hearts", "5 Clubs",
  ...
  def test_should_error_when_given_too_few_cards
    assert_raise Game::NotFiveCards do
      poker_aware_cards_for("5 Clubs", "A Diamonds", "K Diamonds", "5 Hearts")
    end
  end

  def test_should_have_no_pairs
    info = poker_aware_cards_for("3 Spades", "2 Hearts", "5 Clubs",
                                "A Diamonds", "K Diamonds")
    assert_nil info.pairs
  end

  def test_high_and_low_pairs_should_be_same_with_single_pair
    info = poker_aware_cards_for("3 Spades", "5 Hearts", "5 Clubs",
                                "A Diamonds", "K Diamonds")
  ...
  def test_should_have_two_pairs
    info = poker_aware_cards_for("3 Spades", "A Hearts", "5 Clubs",
  ...
  def test_should_have_trips_and_pair
    info = poker_aware_cards_for("3 Spades", "A Hearts", "A Clubs",
                                "A Diamonds", "3 Diamonds")
  ...
  def test_should_be_a_flush
    info = poker_aware_cards_for("3 Spades", "2 Spades", "5 Spades",
                                "A Spades", "K Spades")
    assert info.flush?
  end
  ...
  def test_should_not_be_a_straight
    info = poker_aware_cards_for("10 Spades", "J Diamonds", "2 Spades",
                                "9 hearts", "K Spades")
    assert !info.straight?
    info = poker_aware_cards_for("7 Spades", "8 Spades", "2 Spades",
                                   "10 Spades", "9 Spades")
    assert !info.straight?
  end

  def test_should_be_a_straight
    info = poker_aware_cards_for("10 Spades", "J Diamonds", "Q Spades",
                                "9 hearts", "K Spades")
    assert info.straight?
  end

  def test_ace_to_five_straight
    info = poker_aware_cards_for("2 Spades", "3 Diamonds", "4 Spades",
                                "5 hearts", "A Spades")
    assert info.straight?
  end

  def poker_aware_cards_for(*cards)
