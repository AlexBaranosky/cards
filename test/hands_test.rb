...
class HandsTest < Test::Unit::TestCase
  ...
  def test_should_create_high_card_hand
    hand = best_possible_hand_from("2 Spades", "5 Spades", "J Hearts", "Q Clubs", "8 Spades")
    assert_equal Game::HighCard, hand.class
  end

  def test_should_create_pair_hand
    hand = best_possible_hand_from("2 Spades", "8 Spades", "J Hearts", "Q Clubs", "8 Hearts")
    assert_equal Game::Pair, hand.class
  end

  def test_should_create_two_pair_hand
    hand = best_possible_hand_from("2 Spades", "8 Spades", "Q Hearts", "Q Clubs", "8 Hearts")
    assert_equal Game::TwoPair, hand.class
  end

  def test_should_create_three_of_a_kind_hand
    hand = best_possible_hand_from("2 Spades", "Q Spades", "Q Hearts", "Q Clubs", "8 Spades")
